...
public class AgencyRegistrationSteps extends CommonMethods {
    ...
    public void representative_specifies_valid_otp() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("Representative clicks on submit button")
    public void representative_clicks_on_submit_button() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
